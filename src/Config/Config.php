...
class Config
{
    ...
    const HIDE_ORDERS_LABEL_PRINT_BUTTON = 'DPD_HIDE_ORDERS_LABEL_PRINT_BUTTON';
    ...
    public const DPD_GITHUB_REPO_RELEASE_LATEST_API_URL = 'https://api.github.com/repos/DPDBaltics/PrestaShop-1.7/releases/latest';
    public const DPD_GITHUB_REPO_RELEASE_LATEST_DOWNLOAD_URL = 'https://github.com/DPDBaltics/PrestaShop-1.7/releases/latest/download/dpdbaltics.zip';
